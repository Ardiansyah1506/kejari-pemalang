...
class PelayananPublikController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $message = 'Terima kasih telah mengajukan pertanyaan melalui Kejaksaan Negeri Pemalang. Pengaduan Anda akan segera ditindaklanjuti, dan kami akan mengirimkan pemberitahuan melalui WhatsApp begitu respons telah tersedia di situs kami.';
