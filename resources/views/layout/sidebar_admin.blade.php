...
<div class="relative w-full flex flex-col h-screen overflow-y-hidden">
    ...
    <i class='mr-3'><img src="{{asset('sidebar-user.png')}}" alt=""></i>
            ...
            <a href="{{route('logout')}}" id="logoutButton" class="flex items-center  opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
...
<header class="w-full hidden md:flex md:justify-between justify-center items-center md:bg-white py-2 px-2 md:px-10 ">
    <h1 class="text-xl md:text-2xl font-semibold ">{{$pageTitle}}</h1>
            <a href="{{route('home')}}" class="flex justify-center py-1 px-2 items-center bg-[#f2f2f3] rounded-md text-white">
                <i
