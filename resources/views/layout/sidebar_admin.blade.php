...
<div class="relative w-full flex flex-col h-screen overflow-y-hidden">
    ...
    <i class='mr-3'><img src="{{asset('user-icon.png')}}" alt=""></i>
            ...
            <button id="logoutButton" class="flex items-center  opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
...
<header class="w-full hidden md:flex md:justify-between justify-center items-center md:bg-white py-2 px-2 md:px-10 flex">
    <h1 class="text-xl md:text-3xl font-semibold ">{{$pageTitle}}</h1>
            <div class="flex justify-center py-1 px-3 items-center bg-[#f2f2f3] rounded-md text-white">
                <i
                    class="fa-regular fa-circle-user  text-xl md:text-4xl text-[#718096] hover:text-blue-700 transition font-medium duration-500 "></i>
                <div class="flex items-start flex-col text-black text-sm md:text-md md:py-1 px-1 md:px-2">
                    <small class="font-bold">Ardiansyah</small>
                    <small class="text-[#718096]">Admin</small>
                </div>
            </div>
