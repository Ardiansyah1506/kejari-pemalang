...
@section('content')
    ...
    <div class="flex flex-row  gap-4 justify-between items-end mb-4">
        ...
        <button id="createNew" onclick="toggleModal()"  class="bg-[#228d81] text-white md:px-4 md:py-2 px-2 py-1 text-sm md:text-md rounded hover:cursor-pointer">Tambah</button>
    </div>
